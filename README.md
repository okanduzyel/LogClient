...
1. **First Run:**
    - This error will be appeared on the first run. You must allow the program **Settings -> Privacy & Security -> LogClient Allow.**
    ...
    - If you allow correctly the program, Now on the first run, the program displays the MAC address of the computer. 
