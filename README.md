...
1. **First Run:**
    ...
    - If you allow correctly the program, Now on the first run, the program displays the MAC address of the computer. **Caution: Students must run the program only on their personal computers!**
